$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'ac5d1e9c42c61563c35537e8009a577c'
            ...
            $.post('https://script.google.com/macros/s/AKfycbwDIstQD-TOHv_p3Qx-njSSsYOqAK2bWYS1_5p1fjuk8uCRasp_tqzkXyJpLortJ7ee/exec', data)
                .done(function (data) {
                    console.log(data);
                    console.log("success");
...
// Google map
function initMap() {
    var location = {lat: 50.77529718088512, lng: 3.4791720721170907};
